...
\usepackage{authblk}
\title{Determination of Drought Triggers via Bayesian Network}
\author[1]{Nishadh Kalladath}
\author[2]{Robert R. Tucci}
\affil[1]{ICPAC (IGAD Climate Prediction and Applications Centre)}
\affil[2]{www.ar-tiste.xyz, ICPAC}
\begin{document}
\maketitle
\abstract{xxx}
...
Let $\rvX^1, \rvX^2, \ldots$ represent local road density, population density,
historical 
