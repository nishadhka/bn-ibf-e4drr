...
\url{https://github.com/nishadhka/bn-ibf-e4drr} 

Includes
\begin{itemize}
\item python code (well documented with plenty of docstrings)
\item folder entitled {\tt jupyter\_notebooks} with 3 notebooks
\item folder entitled {white-paper} with latex code and PDF for {\bf preliminary} white-paper 

\url{https://github.com/nishadhka/bn-ibf-e4drr/blob/main/white-paper/anticipatory-action.pdf}
\end{itemize}
...
Find an automatic method of determining triggering
 ...
 \item The new method should be better than Nishadh's way of doing this for Karamoja, based on FAR/HR/AUROC. 
 
 \item The new method should take
 into account {\bf antecedents} like population density, historical catastrophes, soil moisture, etc.
 \end{itemize}
...
\begin{itemize}
\item {\bf bnet (Bayesian network)} (see my free,
open source book 
\url{https://github.com/rrtucci/Bayesuvius/raw/master/main.pdf})
\item Do bnet calculations using {\bf Pyagrum} software at \url{https://pyagrum.readthedocs.io/en/} combined with my auxiliary 
software
\end{itemize}
...
\begin{itemize}
\item So far, I've only used synthetic  data to train bnet. 
{\bf Need real data to train it. 
}
