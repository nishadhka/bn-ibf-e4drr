...
class Prob3:
    ...
    def get_prob3_bin(self, x_flags):
        ...
        prob3 = cost_tot / loss_tot
        return self.br.get_xbin(prob3)
    ...
    def get_cpt(self):
        ...
        for x_flags in product([0, 1] * num_x):
            for prob3_bin in self.num_p_bins:
                if prob3_bin == self.get_prob3_bin(x_flags):
                    ar[row, prob3_bin] = 1
                    break
            row += 1
        return ar
